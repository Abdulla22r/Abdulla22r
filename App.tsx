        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button aria-label="User settings" className="p-2 rounded-full hover:bg-gray-100">
                <User className="h-6 w-6 text-gray-600" />
              </button>
              <button aria-label="Application settings" className="p-2 rounded-full hover:bg-gray-100">
